export const Hero = () => {
  return (
    <div className="relative isolate px-6 lg:px-8 bg-slate-800 overflow-hidden">
      <div
      ...
      <div className="mx-auto max-w-3xl py-28 sm:py-40 lg:py-48 flex flex-col">
        <div className="text-center">
          <img
            className="inline-block h-12 w-12 rounded-full mb-3"
